...
print(Fore.LIGHTMAGENTA_EX+"     [" + Fore.WHITE+"+" + Fore.LIGHTMAGENTA_EX+"]" + Fore.WHITE+" Crash" + Fore.LIGHTMAGENTA_EX+" |" + Fore.WHITE+" To send a crasher that bypasses all anti-raid bots (No Anti-Links)")
print("")
